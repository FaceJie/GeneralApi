...
namespace DataPojo.EntityExtention.Imp
{
    public class BaseRepository<T> : IRepository<T> where T : class
    {
            ...
            where TEntity : class
        {
            ...
            return Common.JsonHelper.JsonClass(list);
        }
        /// <summary>
            ...
            where TEntity : class
        {
            List<object> list = QueryObject<TEntity, TOrderBy>
                 (where, orderby, selector, IsAsc);
            return await Task.Run(() => Common.JsonHelper.JsonClass(list));
        }
        ...
        public virtual PageInfo Query(IQueryable query, int index, int PageSize)
        {
            ...
            return new PageInfo(index, PageSize, count, Common.JsonHelper.JsonClass(enumerable.ToList()));
        }
        #endregion
